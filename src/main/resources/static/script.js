// API Configuration
// For local development, use relative URL. For production, use environment variable or full URL
const API_BASE_URL = window.location.hostname === 'localhost' 
    ? '/api'  // Local development
    : (window.ENV_API_URL || '/api');  // Production - set via env var or relative
